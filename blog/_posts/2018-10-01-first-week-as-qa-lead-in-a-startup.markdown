...
_This article is the third part out of five articles about [joining a startup as the first QA]({{ site.baseurl }}/blog/joining-a-startup-as-the-first-qa/). You can read the previous part about [the 3 things I wish I knew on the first day in a new job]({{ site.baseurl }}/blog/first-day-in-a-new-job/)._
...
And that's it! To sum up, here we are with the 5 things for 5 days of the first week as QA Lead:
...
In the next article of the series, you can read about [6 pieces of advice for the first month as QA Lead in a startup]({{ site.baseurl }}/blog/first-month-as-qa-lead-in-a-startup/).
